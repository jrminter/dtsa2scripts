...
rptDir  = prjDir + '/testInterface Results/'

offUm    = 0.25 # offset in microns
...
sName = "NBS-NiFe-%g-um-from-Epon828-at-%g-kV-%g-Traj" % (offUm, e0, nTraj)

spc = mc3.interface(nbsNiFe, offUm*1.0e-6, Epon828, det, e0, True,
                    nTraj, dose, True, True, xtraParams)
spc.rename(sName)
