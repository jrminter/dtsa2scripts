...
#
# For 500 trajectories at 7 kV:
# This script required 2.406 min
# Elapse: 0:02:24.4
#
# For 50000 trajectories at 7kV:
# This script required 251.504 min
# ...or 4.192 hr
# Elapse: 4:11:30.9
import sys
import os
...
resDir = prjDir + '/sim-zno-on-si-7kV'
jmg.ensureDir(resDir)
rptDir = prjDir + '/sim-zno-on-si-7kV Results/'
