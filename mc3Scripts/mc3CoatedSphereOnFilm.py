...
filmUm    =    0.008 # film (substrate thickness)
...
os.chdir(prjDir)
pyrDir = prjDir + "/mc3CoatedSphereOnFilm Results"
...
spc = jm3.coatedSphereOnFilm(al2o3, radUm*1.0e-6, pt, ctgUm*1.0e-6, c, filmUm*1.0e-06, det, e0=e0, withPoisson=True, nTraj=nTraj, dose=dose, sf=True, bf=True, xtraParams=xtraParams)
