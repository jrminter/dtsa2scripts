# mc3SphereOnSubstrate.py

# Simulation of an Al2O3 sphere on a C substrate
#
# Date        Ver  Who  Notes
...
spc = mc3.sphere(al2o3, radUm*1.0e-6, det, e0, withPoisson=True, nTraj=nTraj, dose=pc*lt, sf=True, bf=True, substrate=c, xtraParams=xtraParams)
