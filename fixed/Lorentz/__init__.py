...
This version has minor fixes by John Minter. It includes Nicholas Ritchie's changes in the
github repository. I added the .1 to the version below...

"""

__revision__ = "$Id: __init__.py Nicholas W. M. Ritchie $"
__version__ = "0.0.5.1. JM note 2020-08-10 did spaces to tabs..."
