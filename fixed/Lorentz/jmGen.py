...
2020-08-10  JRM  0.0.99  Moved MC3 sim functions to jmMC3.py
						 also added startTimer() and
						 endTimer(). Note: Use tabs not spaces. You will
						 save yourself a lot of headaches!

"""

__revision__ = "$Id: jmGen.py John R. Minter $"
__version__ = "0.0.99.1 2020-08-10"
...
def elapsedTime(delta):
	"""elapsedTime(delta)
	Print the elapsed time in sec, min, and hers
	"""
...
def uncoatedSimBulkStd(mat, det, e0, nTraj, outPath,
	...
	a = uncoatedSimBulkStd(cu, det, 15.0, 100, outPath,
					   dim=5.0e-6, lt=100,
